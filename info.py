...
URL = "https://better-lauralee-jisshu1122-97b1d982.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://better-lauralee-jisshu1122-97b1d982.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://better-lauralee-jisshu1122-97b1d982.koyeb.app/".format(FQDN)
else:
    URL = "https://better-lauralee-jisshu1122-97b1d982.koyeb.app/".format(FQDN)
