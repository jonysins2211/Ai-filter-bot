...
URL = "https://lokieztra1993-eeaf20eb540c.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lokieztra1993-eeaf20eb540c.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lokieztra1993-eeaf20eb540c.herokuapp.com/".format(FQDN)
else:
    URL = "https://lokieztra1993-eeaf20eb540c.herokuapp.com/".format(FQDN)
